...
class CitiesModelsNew extends React.Component {
    constructor() {
        super();
        this.state = {
            search: ''
            ...
            <View>
                <List style={{ paddingRight: '8px', textAlign: 'left', direction: 'rtl', backgroundColor: 'white' }} className="picker-list">
                    ...
                    <Picker
                        ...
                        extra={(this.props.activeCity.label ? this.props.activeCity.label : 'أختر محافظة')}
                        className="forss"
                    ...
                    <Picker
                        title={
                            ...
                            />}
                        data={townsList}
                        extra={(this.props.activeTown.label ? this.props.activeTown.label : ( 'أختر منطقة'))}
...
export default connect(mapStateToProps, matchDispatchToProps)(CitiesModelsNew);